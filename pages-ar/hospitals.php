...
<?php include  "../parts/ar/Header.php" ?>
    ...
    <div class="landing">
        <div class="container">
            <div class="title btmAni25002">المستشفيات</div>
            <div class="sub-title btmAni20002">
                <span>الرئيسية / </span>
                <span class="super">المستشفيات </span>
            </div>
        </div>
    </div>
    <!-- End Landing -->
    ...
    <div class="hospital-page">
        <div class="container">
            <a href="../pages-ar/JordanUniversityHospital.php" class="host js-scroll fade-left">
                <img src="../media/host1.jpg" alt="" />
                <div class="tt">مستشفى الجامعة الاردنية</div>
            </a>
            <a href="../pages-ar/JordanUniversityHospital.php" class="host js-scroll fade-left">
                <img src="../media/host1.jpg" alt="" />
                <div class="tt">مستشفى الجامعة الاردنية</div>
