...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Urbanist:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>Jordan University Hospital</title>
</head>
...
<?php include  "../parts/ar/Header.php" ?>
    ...
    <div class="landing">
        <div class="container">
            <div class="title btmAni25002">مستشفى الجامعة الاردنية</div>
            <div class="sub-title btmAni20002">
                <span>الرئيسية / </span>
                <span class="super">مستشفى  </span>
            </div>
        </div>
    </div>
    <!-- End Landing -->
    ...
    <div class="hospital-profile">
        <div class="container">
            <div class="fi">
                ...
                <div class="cv">
                    <div class="name">مستشفى الجامعة الاردنية</div>
                    <div class="major">عمان</div>
                    <p>
                        أن يكون مستشفى الجامعة الأردنية مركزاً عالمياً ومرجعاً لتطوير وتقديم
                        التعليم والتدريب الصحي والبحث العلمي والرعاية الطبية العلاجية
                        والوقائية وفق أعلى المعايير الخاصة بالتعليم والخدمات الصحية.
                    </p>
                </div>
            </div>
            <div class="location">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13533.116745030595!2d35.8747652!3d32.0075503!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151c9f85fac773a3%3A0x6cd6460a4547306f!2sJordan%20University%20Hospital!5e0!3m2!1sen!2sjo!4v1716817434307!5m2!1sen!2sjo"
