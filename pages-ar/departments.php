...
<?php include  "../parts/ar/Header.php" ?>
    ...
    <div class="landing">
        <div class="container">
            <div class="title btmAni25002">الاقسام الطبية</div>
            <div class="sub-title btmAni20002">
                <span>الرئيسية / </span>
                <span class="super">الاقسام الطبية</span>
            </div>
        </div>
    </div>
    <!-- End Landing -->
    ...
    <div class="departments-page">
        <div class="container">
            ...
            <div class="dep">
                ...
                <a href="./internal-medicine.php" class="new js-scroll Fade-btm" data-category="general-surgery">
                    <div class="top">
                        <img src="../media/internal.jpg" alt="">
                    </div>
                    <div class="bottom">
                ...
                <a href="./internal-medicine.php" class="new js-scroll Fade-btm" data-category="pediatrics">
                    <div class="top">
                        <img src="../media/internal.jpg" alt="">
                    </div>
                    <div class="bottom">
                ...
                <a href="./internal-medicine.php" class="new js-scroll Fade-btm" data-category="internal-medicine">
                    <div class="top">
                        <img src="../media/internal.jpg" alt="">
                    </div>
                    <div class="bottom">
