...
<?php include  "../parts/ar/Header.php" ?>
    ...
    <div class="landing">
        <div class="container">
            <div class="title btmAni25002">القلب</div>
    ...
    <div class="disease">
        <div class="container">
            <div class="title">امراض القلب</div>
            <div class="faf">
                <div class="faqs">
                    <div class="faq js-scroll fade-btm">
                        <div class="top">
                            <h3>مرض الشريان التاجي (CAD):</h3>
                            <img class="fa-regular fa-angle-down"  src="../media/icons/arrow-down.svg" alt="">
                            <i class="fa-solid fa-circle-xmark"></i>
                        </div>
                        <p>
                            ويحدث عندما تزود الشرايين التاجية
                            يتم تضييق أو انسداد الدم إلى القلب بسبب
                            تراكم اللويحات الدهنية (تصلب الشرايين).
                        </p>
                    </div>
                </div>
                <div class="faqs">
            ...
            <div class="btnDoc">
                <a href="../pages-ar/doctor.php" class="btn js-scroll fade-btm">
                    عرض الاطباء
                    <div class="image">
