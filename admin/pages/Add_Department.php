          ...
          <div class="card-body">
            <div class="border p-4 rounded">
              <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-white">Add Department</h5>
              </div>
              <hr>
              <form method="POST" action="../backend/insert_department.php" enctype="multipart/form-data">
                <div class="row mb-3">
                    <label for="inputEnterYourName" class="col-sm-3 col-form-label">Department Name in English</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputEnterYourName" name="department_name_english" placeholder="Department Name in English" required>
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Department Name in Arabic</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="inputPhoneNo2" name="department_name_arabic" placeholder="Department Name in Arabic" required>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select" id="input39" name="subcategory_id">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="card">
                            <div class="card-body">
                                <input type="file" id="inputDepartmentImage" name="department_image" accept=".jpg, .png, image/jpeg, image/png" required>
                            </div>
                        </div>
                    </div>
                </div>
