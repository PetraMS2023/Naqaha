...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Urbanist:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>
        <?php echo htmlspecialchars($hospitals['HospitalNameEnglish']); ?>
    </title>
</head>
...
<?php 
    ...
    $sql = "SELECT HospitalNameEnglish, HospitalNameArabic, GovernorateNameEnglish, GovernorateNameArabic, HospitalDescriptionEnglish, HospitalDescriptionArabic, HospitalLocation, HospitalImage FROM hospitals";
    ...
    <div class="landing">
        <div class="container">
            <div class="title btmAni25002">Jordan University Hospital</div>
            <div class="sub-title btmAni20002">
                <span>Home / </span>
                <span class="super">Hospital</span>
            </div>
        </div>
    </div>
    <!-- End Landing -->
    ...
    <!-- End Go Up -->
    <!-- Start Jordan University Hospital -->
    <div class="hospital-profile">
        <div class="container">

        <?php while ($hospitals = $result->fetch_assoc()) : ?>
            <div class="fi">
                <div class="hospital-pic">
                    <img src="<?php echo htmlspecialchars(str_replace('../../', '../', $hospitals['HospitalImage'])); ?>" alt="">
                </div>
                <div class="cv">
                    <div class="name">
                        <?php echo htmlspecialchars($hospitals['HospitalNameEnglish']); ?>
                    ...
                    <div class="major">
                        <?php echo htmlspecialchars($hospitals['GovernorateNameEnglish']); ?>
                    </div>
                    <p>
                        <?php echo htmlspecialchars($hospitals['HospitalDescriptionEnglish']); ?>
                    </p>
                </div>
            </div>
            <div class="location">
                <iframe src="<?php echo htmlspecialchars(str_replace('../../', '../', $hospitals['HospitalLocation'])); ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <?php endwhile; ?>
        </div>
    </div>
    <!-- End Jordan University Hospital -->
    <!-- Start Footer -->
    <div class="footer">
