...
<?php 
    ...
    <div class="landing">
        <div class="container">
            <div class="title btmAni25002">Hospitals</div>
            <div class="sub-title btmAni20002">
                <span>Home / </span>
                <span class="super">Hospitals</span>
            </div>
        </div>
    </div>
    <!-- End Landing -->
    ...
    <div class="hospital-page">
        ...
        <?php while ($hospitals = $result->fetch_assoc()) : ?>
            <a href="../pages-en/JordanUniversityHospital.php" class="host js-scroll fade-left">
