...
<head>
    ...
    <title>Doctor Profile Nqaha</title>
</head>
...
<body>
    ...
    <div class="landing">
        <div class="container">
            <div class="title btmAni25002">doctor profile</div>
            <div class="sub-title btmAni20002">
                <span>Home / </span>
                <span class="super">doctor profile</span>
            </div>
        </div>
    </div>
    <!-- End Landing -->
        ...
        <div class="container">
            <?php while ($news = $result->fetch_assoc()) : ?>
                ...
                <div class="cv">
                    ...
                    <p>
                        <?php echo htmlspecialchars($doctors['DoctorCVEnglish']); ?>
                    </p>
                </div>
            </div>
                <div class="reel">
                    <video src="<?php echo htmlspecialchars($doctors['DefinitionVideo']); ?>" controls autoplay></video>
                </div>
                <?php endwhile; ?>
        </div>
    </div>
